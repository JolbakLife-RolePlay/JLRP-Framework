Locales["en"] = {
	...
	["command_adminduty"] = "Toggle AdminDuty On/Off",
    ["command_adminduty_not_authorized"] = "You are ~r~NOT~s~ authorized to use this command!",
	["command_me"] = "Show personal actions, face expressions, etc...",
	["command_me_message"] = "message",
	["command_me_no_message"] = "You need to enter a message",
	...
	["commanderror_missing_args"] = "All arguments must be filled out!",
